-- Migration 014: Seed system_prompt for canonical stages
-- Copies the TypeScript fallback prompts into kanban_stages.system_prompt
-- so they are editable via /crm/config without redeploy.
-- Source: src/workflows/prompts/stages/index.ts
